        ...
        <section class="container">
            <article class="container">
                ...
                <ul>
                    ...
                    <h2>Yoshi</h2>
                    <p>Yoshi heeft dezelfde taak als Usain Bolt, maar hij is ook de beste scooter van Shabu to go.<br>
                        Een scooter kan helemaal niet springen, maar hij kan wel heel hoog springen.</p>
                </ul>
            </article>
        </section>
